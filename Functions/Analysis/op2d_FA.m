function [op2d,fld] = op2d_FA(imageData)
...
xy = imageData.xy_nm;  % This is how FiberApp handles the xy data
gridStep = 4*step;
...
fld = 1000*size(p_im, 2)*step/((xMax-xMin)*(yMax-yMin));
% imageData.fibLengthDensity = fibLengthDensity;
